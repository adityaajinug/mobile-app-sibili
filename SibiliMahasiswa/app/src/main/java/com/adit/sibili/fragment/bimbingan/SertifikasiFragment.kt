 ...
 * Use the [SertifikasiFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SertifikasiFragment : Fragment(), BimbinganMenuAdapter.ItemAdapterCallback {
    ...
    private fun addData() {
        ...
        menuArrayList.add(BimbinganMenuModel("User Guide", "Sertifikasi I", R.drawable.panduan,1 ))
        menuArrayList.add(BimbinganMenuModel("User Guide", "Sertifikasi II", R.drawable.panduan_kedua, 2))
    }
    override fun onClick(v: View, data: BimbinganMenuModel) {
        if(data.desc == "Sertifikasi I") {
            Toast.makeText(context, "sertif 1", Toast.LENGTH_SHORT).show()
        } else if(data.desc == "Sertifikasi II") {
            Toast.makeText(context, "sertif 2", Toast.LENGTH_SHORT).show()
        }
    }
}
