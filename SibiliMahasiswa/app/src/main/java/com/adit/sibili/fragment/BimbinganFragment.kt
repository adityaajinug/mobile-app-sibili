...
import com.adit.sibili.databinding.FragmentBimbinganBinding
import com.adit.sibili.databinding.FragmentKkiBinding
import com.adit.sibili.fragment.bimbingan.SectionPagerAdapter
...
class BimbinganFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val sectionPagerAdapter = SectionPagerAdapter(childFragmentManager, 3)
